...
const {productosControl}= require("../controles");
//establecemos el router.get el cual listara todos los resultados obtenidos de los objetos almacenados
 //llamamos el metodo getProductos qeu se hizo en el arvhico de controlardores 
 router.get('/',productosControl.getProductos);
 //establecemos el router.post el cual  agregara a  el objeto isertado por el usuaario a los almacenados
 //llamamos el metodo createProducto  qeu se hizo en el arvhico de controlardores
 router.post('/', productosControl.createProducto);  
 ...
 //llamamos el metodo updateProducto  qeu se hizo en el arvhico de controlardores
 router.put('/', productosControl.updateProducto);
 ...
 //llamamos el metodo deleteProducto  qeu se hizo en el arvhico de controlardores
 router.delete('/',  productosControl.deleteProducto);
